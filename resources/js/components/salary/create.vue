    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-6">
                ...
                <select class="form-control" id="exampleFormControlSelect1" style="appearance:auto;" v-model="form.salary_month">
...
export default {
  ...
  methods:{
    SalaryPaid(){
        ...
        .then(({data}) => {
            console.log(data);
            if (data == 'Salary Already Paid') {
                Notification.SalaryPaid(this.form.salary_month);
                return;
            }
