<template>
    <div>
    <div>
        <router-link to="/employee" class="btn btn-primary">All Customer</router-link>
    </div>
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-6">
                <strong><label for="exampleFormControlTextarea1">Customer Name</label></strong>
                <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Name" v-model="form.name">
                <small class="text-danger" v-if="errors.name">{{errors.name[0]}}</small>
            </div>
            <div class="col-md-6">
                <strong><label for="exampleFormControlTextarea1">Customer Email</label></strong>
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-6">
                <strong><label for="exampleFormControlTextarea1">Customer Address</label></strong>
            ...
            <div class="col-md-6">
                <strong><label for="exampleFormControlTextarea1">Customer Phone</label></strong>
