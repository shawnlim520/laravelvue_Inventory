...
<head>
  ...
  <title>VueJS Inventory - Dashboard</title>
...
<div id="app">
    <div id="wrapper">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <img src="{{asset('backend/img/logo/cckfm_logo_squareround.png')}}">
            </div>
            <div class="sidebar-brand-text mx-3">CCK Inventory</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <router-link to="/searchorder" class="collapse-item">Search Order</router-link>
            </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    <span class="ml-2 d-none d-lg-inline text-white small">Shawn Lim</span>
                </a>
